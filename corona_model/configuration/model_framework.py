...
class AgentBasedModel:
    ...
    def initializeInterventionsAndPermittedActions(self):
        ...
        self.flucuateSocial = self.config["World"]["FluctuatingSocial"]
                        ...
                        if self.agents[agentId].state == "susceptible":
                            ...
                            if randVec[index1] < coeff*totalInfection:
                                ...
                                if self._debug:
                                    ...
                                    if self.flucuateSocial and room.building_type == "social":
    ...
    def infectionInRoom(self, roomId):
        ...
        contribution = self.infectionWithinPopulation(self.rooms[roomId].agentsInside, roomId)
        if self.flucuateSocial and self.rooms[roomId].building_type == "social" and not self.rooms[roomId].room_name.endswith("_hub"): # check for division by zero
